package nadirian.hamlet.android.encdecapp.model.crc16_checksum

object CRC16CheckSum {
    val crc16Table = intArrayOf(
        0x0000, 0xC0C1, 0xC181,
    ...
    fun crc16checksum(input: String): Int {
        val bytes = input.toByteArray()
        var crc = 0x0000
        for (b in bytes) crc = crc ushr 8 xor crc16Table[crc xor b.toInt() and 0xff]
        return crc
    }
}